...
if __name__ == '__main__':
    ...
    parser.add_argument('--scen', type=str, default='VIVP', help='test scene, R: Relax, E: Exercise, FIFP, VIFP, FIVP, VIVP')
    ...
    parser.add_argument('--method-name', default='POS', help='create model name')
