...
class TorchLossComputer(object):
    ...
    def cross_entropy_power_spectrum_focal_loss(inputs, target, Fs, gamma):
        ...
        #pdb.set_trace()
        criterion = pdb.FocalLoss(gamma=gamma)
...
if __name__ == '__main__':
    ...
    # 计算损失
    loss_value = criterion(fake_pred_bvp, fake_gt_bvp, epoch, FS, diff_flag)

    # 输出损失值
    print(f"RhythmFormer Loss: {loss_value.item():.6f}")